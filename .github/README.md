...
[`@aws-sdk/client-marketplace-entitlement-service`](https://www.npmjs.com/package/@aws-sdk/client-marketplace-entitlement-service/v/3.198.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-marketplace-entitlement-service@3.198.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-opSeZJS+k9zncI1ofOTPsVZQ8CfLJmV299RcymwpeSyaY9o+3IY5sYL1x2l+1Bxg
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-marketplace-entitlement-service": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-marketplace-entitlement-service@3.198.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-marketplace-entitlement-service@3.198.0/index.min.mjs": "sha384-opSeZJS+k9zncI1ofOTPsVZQ8CfLJmV299RcymwpeSyaY9o+3IY5sYL1x2l+1Bxg"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-marketplace-entitlement-service/blob/refs/tags/3.198.0/LICENSE
```
